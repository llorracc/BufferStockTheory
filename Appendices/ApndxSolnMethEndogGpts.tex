...
\newcommand{\subname}{ApndxSolnMethEndogGpts}
...
\compilingasstandalone{\bibstandalone{ApndxSolnMethEndogGpts}}\end{document}\endinput
...
the true consumption function within the grid.
But if any such interpolation is extended beyond the
