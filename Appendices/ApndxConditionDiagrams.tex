...
%% Difficulties with multply defined labels occur if the figure is reproduced, so comment this out 
...
%\notinsubfile{\bibliography{\LaTeXGenerated/BufferStockTheory,\econtexBib}}
