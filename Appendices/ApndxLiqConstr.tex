...
\end{aligned}\end{gathered}\end{equation} \hypertarget{FHWFacDefn}{}\hypertarget{PFRNrmByGRndDefn}{}
...
\begin{equation}\begin{gathered}\begin{aligned}\labelsafe{eq:cFuncPFUncAppx}
