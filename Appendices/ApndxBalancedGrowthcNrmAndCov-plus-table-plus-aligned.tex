...
\begin{figure}[ht]
  \centerline{
    \includegraphics[width=4in]{\econtexRoot/Figures/logcNrm}
  }
...
\begin{figure}[ht]
  \centerline{
    \includegraphics[width=4in]{\econtexRoot/Figures/logcov}
  }
  \caption{Appendix: $\log ~(-\cov(\cNrm,\permLvl))$ Appears to Grow Linearly}
  \label{fig:logcov}
\end{figure}

(See \eqref{eq:DBCparts}) %\input{../Equations/DBCParts}
