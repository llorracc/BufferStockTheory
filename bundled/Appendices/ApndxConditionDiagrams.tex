...
\begin{figure}
\centering
\includegraphics[width=4in]{\econtexRoot/Figures/InequalityPFGICFHWCRIC}
...
\begin{figure}[ht]
  \centerline{
    \includegraphics[width=6in]{\econtexRoot/Figures/Inequalities}
  }
...
\begin{figure}[ht]
  \centerline{
    \includegraphics[width=6in]{\econtexRoot/Figures/Inequalities-numer}
  }
  \caption{Appendix: Numerical Relation of All Inequality Conditions}\label{fig:InequalitiesAppNumer}
\end{figure}

%\notinsubfile{\bibliography{BufferStockTheory,\econtexBib}}
%\notinsubfile{\pagebreak\bibliography{\econtexRoot/\texname,\econtexBib}}
