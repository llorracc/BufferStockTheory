...
\input{./.econtexRoot}\input{\econtexRoot/@resources/tex-add-search-paths}
...
\notinsubfile{\renewcommand{Tables}{./Tables}} % Not sure why this needs to be redefined here; if not, tries to write to ../../Tables

\let\TableWidth\relax % Necessary to allow redefinition of tablewidth, which might already be defined
\newlength\TableWidth
\begin{verbatimwrite}{\econtexRoot/Tables/\TblName}
  ...
  \begin{table}
    ...
    \sbox{\TblBox}{
      \begin{tabular}{|c|ccl|c|}
        ...
        \hypertarget{PermGroFacAdjU}{}\hyperlink{PermGroFacAdjU}{Utility Compensated Growth}                     & $\PermGroFacAdjU $ & $\equiv$ & $ \PermGroFac \uInvEuPermShk$        & 1.020 \\
...
\end{verbatimwrite}
\clearpage
\input{\econtexRoot/Tables/\TblName}
