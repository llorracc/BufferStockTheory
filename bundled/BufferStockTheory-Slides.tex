...
% Match BufferStockTheory.tex: \APFac in econark-shortcuts expands via \Thorn
\providecommand{\Thorn}{\pmb{\TH}}
...
\input{\econtexRoot/Equations/FVAC}
...
\input{\econtexRoot/Equations/PermGroFacAdj}
...
\centerline{\includegraphics[width=4in]{\econtexRoot/Figures/cNrmTargetFig.pdf}}
\end{frame}

\subsection{Bounds On The Consumption Function}
\begin{frame}
\frametitle{Bounds On the Consumption Function}
\centerline{\includegraphics[width=4in]{\econtexRoot/Figures/cFuncBounds.pdf}}
\end{frame}

\begin{frame}
\frametitle{The Marginal Propensity to Consume}
\centerline{\includegraphics[width=4in]{\econtexRoot/Figures/MPCLimits.pdf}}
\end{frame}
...
\centerline{\includegraphics[height=2.5in]{\econtexRoot/Figures/SimCDFsConverge.pdf}}
...
\pagebreak\providecommand{\bibfiles}{}\renewcommand{\bibfiles}{\econarkcollectbibs{\econtexRoot/\texname}}\bibliography{\bibfiles}
