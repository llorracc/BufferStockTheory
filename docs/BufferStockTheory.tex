...
%%% But in [econark.sty](https://github.com/llorracc/SolvingMicroDSOPs-Latest/blob/master/.resources/texmf-local/tex/latex/local-econark.sty,
%%% \phi is used for a persistent shock (if it exists)
%%% and generally we have used up all the Greek letters for one thing or another there
%%% That's why I used a Greek character that's \emph{off the menu}
%%% Let's discuss
