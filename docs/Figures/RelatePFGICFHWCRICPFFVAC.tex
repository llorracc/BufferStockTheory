\begin{figure}[ht] % todo: fix notes so they are justified
 \ifthenelse{\boolean{Web}}{ % Web 
  \centerline{ % Web 
    \includegraphics[width=0.7\linewidth]{\econtexRoot/Figures/RelatePFGICFHWCRICPFFVAC} % Web 
  } % Web 
...
\end{figure} % Web  
  ...
  \centerline{
    \includegraphics[width=5in]{\econtexRoot/Figures/RelatePFGICFHWCRICPFFVAC}
  }
