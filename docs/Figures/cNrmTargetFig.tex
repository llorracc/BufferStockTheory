...
\centerline{\includegraphics[width=0.8\linewidth]{\econtexRoot/Figures/cNrmTargetFig}} % Web 
\caption{`Stable' $\mNrm$ Values and Expected Growth Rates} % Web 
\label{fig:cNrmTargetFig} % Web
\end{figure} % Web
}{ % Web - no
\begin{figure}[tbp]
\centerline{\includegraphics[width=0.8\textwidth]{\econtexRoot/Figures/cNrmTargetFig}}
