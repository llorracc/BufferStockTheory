...
\centerline{\includegraphics[width=0.8\textwidth]{\econtexRoot/Figures/GICModFailsButGICRawHolds}}
\caption{Convergence of the Consumption Rules} % Web 
\label{fig:GICModFailsButGICRawHolds}
\end{figure} % Web
}{ % Web - no
\begin{figure}[tbp]
\centerline{\includegraphics[width=6in]{\econtexRoot/Figures/GICModFailsButGICRawHolds}}
\caption{}
