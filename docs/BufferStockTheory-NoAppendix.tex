...
\hypertarget{\figFile}{}
\input{\econtexRoot/Figures/cNrmTargetFig}
...
\begin{verbatimwrite}{\econtexRoot/Equations/TheoremMTargetIsStable}
...
If \hyperlink{WRIC}{weak return impatience} (Assumption \ref{ass:WRIC}), \hyperlink{FVAC}{finite value of autarky} (Assumption \ref{ass:FVAC}) and \hyperlink{GICMod}{strong growth impatience} (Assumption \ref{ass:GICMod}) hold, then there exists $\mTrgNrm$, with $\mTrgNrm>0$, such that:
  ...
  \end{theorem}
\end{verbatimwrite} \unskip
\input{\econtexRoot/Equations/TheoremMTargetIsStable}
...
\begin{verbatimwrite}{\econtexRoot/Equations/TheoremMSSBalExists}
...
If \hyperlink{WRIC}{weak return impatience} (Assumption \ref{ass:WRIC}), \hyperlink{FVAC}{finite value of autarky} (Assumption \ref{ass:FVAC}) and \hyperlink{GIC}{growth impatience} (Assumption \ref{ass:GICRaw}) hold, then there exists a unique $\mBalLvl$, with $\mBalLvl>0$ such that:
  ...
  \end{theorem}
\end{verbatimwrite} \unskip
\input{\econtexRoot/Equations/TheoremMSSBalExists}
\begin{proof}
...
\begin{comment}
  ...
  \begin{verbatimwrite}{\econtexRoot/Equations/TheoremGroIsStable}
    ...
    \end{theorem}
  \end{verbatimwrite}
  \input{\econtexRoot/Equations/TheoremGroIsStable}
...
\hypertarget{\figFile}{}
\input{\econtexRoot/Figures/GICModFailsButGICRawHolds}
...
\hypertarget{\figName}{}
\input{\econtexRoot/Figures/\figName} % Read in the tex to generate the figure
...
\input{\econtexRoot/Tables/Parameters}

\hypertarget{Symbols}{}
\input{\econtexRoot/Tables/Calibration}
...
\input{\econtexRoot/Tables/Comparison}

\hypertarget{Required}{}
\input{\econtexRoot/Tables/Required}
