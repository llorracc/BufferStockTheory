...
\newlength\TableWidth
\begin{verbatimwrite}{\econtexRoot/Tables/LiqConstrScenarios}
...
%    \iflabelexists{table:LiqConstrScenarios}{}{\label{table:LiqConstrScenarios}} % Don't define it if already defined
    \label{table:LiqConstrScenarios} % Don't define it if already defined
  ...
  \end{verbatimwrite}
  \clearpage
  \input{\econtexRoot/Tables/LiqConstrScenarios}
