  \begin{table}[!th]
    \centering
    \caption{Definitions and Comparisons of}
...
\multicolumn{2}{|c|}{Finite Human Wealth} \\ \hline % add hyperlink
...
\multicolumn{1}{|c|}{Return Impatience Condition} & \multicolumn{1}{c|}{Weak \RIC~(\WRIC)} \\ \hline
