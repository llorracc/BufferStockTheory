  \begin{table}[!th]
    \centering
    \caption{Definitions and Comparisons of Consumer Patience Conditions}
    \labelsafe{table:Comparison}
...
\multicolumn{2}{|c|}{Finite Limiting Human Wealth (FHWC)} \\ \hline % add hyperlink
...
&  \\
&  \\ \hline
\multicolumn{2}{|c|}{Absolute Impatience Condition} \\ \hline
$\APFac < 1$                                        &  $\APFac < 1$ \\
...
& \\ \hline
\multicolumn{2}{|c|}{Return Impatience} \\ \hline
...
& \\ \hline
\multicolumn{2}{|c|}{Growth Impatience} \\ \hline
\multicolumn{1}{|c|}{Growth Impatience Condition (\GICRaw)} & \multicolumn{1}{c|}{Strong Growth Impatience (\GICMod)} \\ \hline
...
& $\displaystyle \lim_{\mNrm_{t} \rightarrow \infty} \Ex_{t}[\mNrm_{t+1}/\mNrm_{t}] = \GPFacMod $
 \\
&  \\ \hline
\multicolumn{2}{|c|}{Finite Value of Autarky} \\ \hline
