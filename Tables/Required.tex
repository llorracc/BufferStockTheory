...
%    \centering
    ...
    \sbox{\TblBox}{
      \begin{tabular}{|l|l|l|} \hline
        ...
        \\                                                                                                                      & \textcolor{red}{Section} \ref{subsec:LimitsAsmtToZero}   & $\underline{\vFunc}(\mNrm) < \usual{\vFunc}(\mNrm) < \bar{\vFunc}(\mNrm)$ %
        ...
        \\ \cline{2-3}\multicolumn{1}{|r|}{Section \ref{subsec:eventuallyCauchy}:}                            & \FVAC, \WRIC                      & Sufficient for Contraction
        ...
        \\ \multicolumn{1}{|r|}{Section \ref{sec:discussConvergence}: Case 3}
                                                                                                                               &                                 & \cncl{\FHWC}+{\RIC} $\Rightarrow ${\GICRaw}$, \lim\limits_{\mNrm \rightarrow \infty} \usual{\MPCFunc}(\mNrm)=\MPCmin$
        \\  \multicolumn{1}{|r|}{Section \ref{sec:discussConvergence}: Case 1}                                        &                                 & \cncl{\RIC}  $\Rightarrow $\cncl{\FHWC}$, \lim\limits_{\mNrm \rightarrow \infty} \usual{\MPCFunc}(\mNrm)=0$
