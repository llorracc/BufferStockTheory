...
%    \iflabelexists{table:Required}{}{\label{table:Required}} % Don't define it if already defined
    ...
    \sbox{\TblBox}{
      \begin{tabular}{|l|l|l|} \hline
        ...
        \\ \multicolumn{1}{|r|}{Eq \eqref{eq:FHWCandPFFVACimplyRIC} in \hyperlink{PFBProofs}{Appendix \ref{subsec:PFBProofs}}:}                                                                              &                                         & {\PFFVAC}+{\FHWC} $\Rightarrow$ {\RIC}
        \\ \multicolumn{1}{|r|}{{Eq \eqref{eq:GICandFHWCimplyPFFVAC} in \hyperlink{PFBProofs}{Appendix \ref{subsec:PFBProofs}}:}}                                                                              &                                         & {\GICRaw}+{\FHWC} $\Rightarrow$ {\PFFVAC}
