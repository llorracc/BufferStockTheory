...
%
\begin{verbatimwrite}{\econtexRoot/Equations/supfn}
...
\input{\econtexRoot/Equations/supfn}
...
\begin{verbatimwrite}{\econtexRoot/Equations/DBCparts}
  ...
  \end{equation}
\end{verbatimwrite}\unskip
\input{\econtexRoot/Equations/DBCParts}
...
\begin{verbatimwrite}{\econtexRoot/Equations/TranShkDef}
  \begin{equation}
    \tranShkAll_{t}=
    \begin{cases}
  ...
  \end{equation}
\end{verbatimwrite}\unskip
\input{\econtexRoot/Equations/TranShkDef}
...
\end{equation}
\end{verbatimwrite} \unskip
\input{\econtexRoot/Equations/boundFunc}
