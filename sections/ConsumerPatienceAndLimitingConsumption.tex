...
\subsubsection{Behavior Under Cases of Conditions}\label{subsubsec:casesUC}\label{sec:discussConvergence}% sec:discussConvergence re-added here after restructure; referenced by Tables/Required

\hypertarget{IntuitionRIC}{}
%\subsubsection{When the {RIC}~Fails}\label{subsubsec:WhenTheRICFails}
\paragraph{Case 1: Return impatience fails and growth impatience holds}\label{subsubsec:WhenTheRICFails}
...
\paragraph{Case 2: Return impatience holds and growth impatience holds with finite human wealth}\label{subsubsec:WhenTheRICHolds}
